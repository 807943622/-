...
#define  PRODUCTKEY           "a1WB2NFrVTa"                                 //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
#define  DEVICENAME           "esp8266"                                        //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
#define  DEVICESECRE          "AseWqUh830npDLeI0qnTFup1QyDXYyQX"            //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a1WB2NFrVTa/esp8266/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a1WB2NFrVTa/esp8266/thing/event/property/post"    //需要发布的主题     
															


//#define  PRODUCTKEY           "a1XQxdf854f"                                 //产品ID
//#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                            //产品ID长度
//#define  DEVICENAME           "PC_MQTT"                                        //设备名  
//#define  DEVICENAME_LEN       strlen(DEVICENAME)                            //设备名长度
//#define  DEVICESECRE          "RFe2cXcBRcvt6UZn4JUTDS1QGDA6nF3J"            //设备秘钥   
//#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                           //设备秘钥长度
//#define  S_TOPIC_NAME         "/sys/a1XQxdf854f/PC_MQTT/thing/service/property/set"   //需要订阅的主题  
//#define  P_TOPIC_NAME         "/sys/a1XQxdf854f/PC_MQTT/thing/event/property/post"    //需要发布的主题     
