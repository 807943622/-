...
//WIFI 连接标识   16*16
uint8  const  Wifi_On_ico[] = {
0x00,0x00,0x00,0x00,0x07,0xE0,0x1F,0xF8,0x78,0x1E,0xE0,0x07,0x87,0xE1,0x0F,0xF0,
0x1C,0x38,0x11,0x88,0x03,0xC0,0x02,0x40,0x00,0x00,0x01,0x80,0x01,0x80,0x00,0x00
};

//WIFI 断开标识   16*16
uint8  const  Wifi_Off_ico[] = {
0x00,0x00,0x03,0xE0,0x0F,0xF8,0x1C,0x9C,0x34,0x92,0x7E,0xF2,0x6F,0x93,0x44,0x93,
0x44,0xFF,0x6E,0xCF,0x7F,0x87,0x74,0x86,0x32,0xEC,0x1E,0x7E,0x07,0xF7,0x01,0xE3
};

//太阳雨标识
uint8  const  Weather_RainSun[] = {
0x00,0x00,0x06,0x40,0x36,0x80,0x3F,0x80,0x1B,0x00,0x39,0xF0,0x0F,0xB8,0x0E,0x1C,
0x1C,0x06,0x30,0x02,0x20,0x06,0x3F,0xFE,0x1F,0xF8,0x0B,0x58,0x0B,0x58,0x00,0x00
};


//FFT 图标
uint8  const  FFT_Function_Icon[] = {
0x5F,0xC0,0x00,0xF2,0x40,0x00,0x5D,0x40,0x00,0x24,0xA0,0x00,0xCB,0x50,0x00,0xB4,
0x90,0x00,0xC8,0x10,0x00,0xE9,0x30,0x00,0x14,0x30,0x00,0x68,0x78,0x00,0x11,0xFC,
0x00,0x0F,0xE2,0x00,0x00,0xE3,0x00,0x00,0x63,0x80,0x00,0x3C,0x40,0x00,0x0C,0x60,
0x00,0x04,0x70,0x00,0x03,0xF0,0x00,0x01,0xF0,0x00,0x00,0xE0,0x00,0x00,0x02,0x00,
0x00,0x07,0x00,0x00,0x0E,0x00,0x00,0x04
};
...
* 出口参数：无
****************************************************************************/
void  FFT_Function_image(uint32 x, uint32 y)
{  GUI_LoadPic(x, y, (uint8 *) FFT_Function_Icon, 24, 24);
}
...
* 出口参数：无
****************************************************************************/
void  GUI_WIFI_ON(uint32 x, uint32 y)
{  GUI_LoadPic(x, y, (uint8 *) Wifi_On_ico, 16, 16);
}
...
* 出口参数：无
****************************************************************************/
void  GUI_WIFI_OFF(uint32 x, uint32 y)
{  
	GUI_LoadPic(x, y, (uint8 *) Wifi_Off_ico, 16, 16);
}

/****************************************************************************
* 名称：GUI_Weather_RainSun()
* 功能：//太阳雨标识图标
* 入口参数： x		指定显示位置，x坐标
*           y		指定显示位置，y坐标
* 出口参数：无
****************************************************************************/
void  GUI_Weather_RainSun(uint32 x, uint32 y)
{  
	GUI_LoadPic(x, y, (uint8 *) Weather_RainSun, 16, 16);
}
