...
#define I2S_RX_DMA_BUF_SIZE    	64		//定义RX DMA 数组大小
...
void I2S_GPIO_Init(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE);			//使能外设GPIOB,GPIOC时钟
   
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN;//复用功能
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_100MHz;
	GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_DOWN;//上拉 = GPIO_PuPd_UP;//推挽输出
...
////
//	I2S2_Init(I2S_Standard_MSB,I2S_Mode_MasterTx,I2S_CPOL_High,I2S_DataFormat_24b);			//飞利浦标准,主机发送,时钟低电平有效,16位帧长度 
//	I2S2ext_Init(I2S_Standard_MSB,I2S_Mode_SlaveRx,I2S_CPOL_High,I2S_DataFormat_24b);		//飞利浦标准,从机接收,时钟低电平有效,16位帧长度	
//	I2S2_SampleRate_Set(1600);	//设置采样率 
